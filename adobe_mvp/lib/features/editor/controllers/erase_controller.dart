...
class EraseController extends ChangeNotifier {
  final Ref _ref;
  
  EraseController(this._ref);
  ...
  Future<void> eraseSelection() async {
    ...
    try {
      ...
      // Call the erase API using convenience method
      final String resultPath = await AiApi.eraseCurrentSelection(
      ...
      if (_resultImage != null) {
        ...
        // Clear selections after successful erase
...
// Provider
final eraseControllerProvider = ChangeNotifierProvider<EraseController>(
  (ref) => EraseController(ref),
);